#pragma checksum "E:\Git\NewsPublish\NewsPublish.Web\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "94bc8b67daa75b666e30d1c550d4274a5ccbf6a6"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"94bc8b67daa75b666e30d1c550d4274a5ccbf6a6", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "E:\Git\NewsPublish\NewsPublish.Web\Views\Home\Index.cshtml"
...
#line hidden
    ...
    <div class=""content"">
        <div id=""focusslide"" class=""carousel slide"" data-ride=""carousel"">
            ...
            <a class=""left carousel-control"" href=""#focusslide"" role=""button"" data-slide=""prev"" rel=""nofollow""> <span class=""glyphicon");
            WriteLiteral(@" glyphicon-chevron-left"" aria-hidden=""true""></span> <span class=""sr-only"">上一个</span> </a> <a class=""right carousel-control"" href=""#focusslide"" role=""button"" data-slide=""next"" rel=""nofollow""> <span class=""glyphicon glyphicon-chevron-right"" aria-hidden=""true""></span> <span class=""sr-only"">下一个</span> </a>
        </div>
    ...
    <div class=""fixed"">
     ...
     ");
        ...
        <div class=""widget widget_search"">
            ");
            EndContext();
            BeginContext(3132, 515, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "94bc8b67daa75b666e30d1c550d4274a5ccbf6a67722", async() => {
                BeginContext(3189, 451, true);
                WriteLiteral(@"
            ...
            EndContext();
            BeginContext(3647, 5678, true);
            WriteLiteral(@"
        </div>
    </div>
    <div class=""widget widget_hot"">
        <h3>最新评论文章</h3>
        <ul id=""news_comment""></ul>
    </div>
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    for (var i = 0; i < data.data.length; i++) {
                        var m = data.data[i];
                        var news;
                        news = '<article class=""excerpt excerpt-1"" style=""""><a class=""focus"" ");
            WriteLiteral(@"href=""/News/Detail?id=' + m.id + '"" title=""' + m.title + '"" target=""_blank""><img class=""thumb"" data-original=""' + m.image + '"" src=""' + m.image + '"" alt=""' + m.title + '"" style=""display: inline;""></a><header><h2><a href=""/News/Detail?id=' + m.id + '"" title=""' + m.title + '"" target=""_blank"">' + m.title + '</a></h2></header><p class=""meta""><time class=""time""><i class=""glyphicon glyphicon-time""></i>' + m.publishDate + '</time><a class=""comment"" title=""评论"" target=""_blank""><i class=""glyphicon glyphicon-comment""></i> ' + m.commentCount + '</a></p><p class=""note"">' + m.contents + '</p></article>';
