#pragma checksum "E:\Git\NewsPublish\NewsPublish.Web\Areas\Admin\Views\News\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6a8be4a4d624e256955add6ca96077f5a96cd265"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6a8be4a4d624e256955add6ca96077f5a96cd265", @"/Areas/Admin/Views/News/Index.cshtml")]
    public class Areas_Admin_Views_News_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<NewsPublish.Model.Response.ResponseModel>
    {
        #line hidden
        ...
        {
#line 1 "E:\Git\NewsPublish\NewsPublish.Web\Areas\Admin\Views\News\Index.cshtml"
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6a8be4a4d624e256955add6ca96077f5a96cd2653139", async() => {
...
");
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(1130, 6901, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6a8be4a4d624e256955add6ca96077f5a96cd2655377", async() => {
                BeginContext(1136, 528, true);
                WriteLiteral(@"
...
");
                EndContext();
#line 33 "E:\Git\NewsPublish\NewsPublish.Web\Areas\Admin\Views\News\Index.cshtml"
                 if (Model.code == 200)
                {
...
#line 37 "E:\Git\NewsPublish\NewsPublish.Web\Areas\Admin\Views\News\Index.cshtml"
WriteAttributeValue("", 1844, classify.Id, 1844, 12, false);
...
#line hidden
                ...
                WriteLiteral("</option>\r\n");
                EndContext();
#line 38 "E:\Git\NewsPublish\NewsPublish.Web\Areas\Admin\Views\News\Index.cshtml"
                    }
                }

#line default
#line hidden
                BeginContext(1925, 6099, true);
                WriteLiteral(@"            </select>
            &nbsp;
    ...
    <script type=""text/javascript"">
        ...
        function search() {
            ...
            pageIndex = 1;
            getNews(pageIndex, 20, classifyId, keyword);
        }
           ...
           ");
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < result.data.length; i++) {
                        var tr = '<");
                WriteLiteral(@"tr class=""text-c""><td>' + result.data[i].id + '</td><td>' + result.data[i].classifyName + '</td><td>' + result.data[i].title + '</td><td>' + result.data[i].contents + '</td><td>' + result.data[i].publishDate + '</td><td>' + result.data[i].remark + '</td><td class=""f-14 user-manage""><a title=""删除"" href=""javascript:;"" onClick=""del(this,' + result.data[i].id + ')"" class=""ml-5"" style=""text-decoration:none""><i class=""icon-trash""></i></a></td></tr>';
                ...
                WriteLiteral(@"ess: function (result) {
                        if (result.code == 200) {
                            ...
                            if (currentPageCount == 1) {
                                ...
                                //getNews(pageIndex, pageSize, classifyId, keyword);   两个方法都可以
                                $(obj).parents(""tr"").remove();
                            }
                        } else {
